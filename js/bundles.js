...
var _lottery_data = __webpack_require__(5);

var _localhandle = __webpack_require__(6);

var gift = __webpack_require__(7);
var tpl = __webpack_require__(24);
var wish = __webpack_require__(25);
...
function initLocal() {
    if (!localStorage.getItem('lottery_initial')) {
        var data_str = JSON.stringify(_lottery_data.lottery_initial_datas);
        localStorage.setItem('lottery_initial', data_str);
    }
    if (!localStorage.getItem('award_initial')) {
        var award_str = JSON.stringify(_lottery_data.award_config);
        localStorage.setItem('award_initial', award_str);
    }
}

function lotteryLists() {
    var lotteryList = [{ 'name': '特等奖', 'num': 1, 'price': '人民币 ¥ 5000.00' }, { 'name': '神秘奖', 'num': 1, 'price': '我也不知道是啥！' }, { 'name': '一等奖', 'num': 1, 'price': '人民币 ¥ 2800.00' }, { 'name': '二等奖', 'num': 2, 'price': '人民币 ¥ 1800.00' }, { 'name': '三等奖', 'num': 3, 'price': '人民币 ¥ 800.00' }, { 'name': '幸运奖', 'num': 6, 'price': '人民币 ¥ 400.00' }];
...
var award_log = null;
function awardLogs() {
    if (!_localhandle.local_handle.get("award_log")) {
...
function initList() {
    if (!_localhandle.local_handle.get("lottery_datas")) {
...
function getAward() {
    ...
    array.forEach(function (o, k) {
        if (_localhandle.local_handle.get('award_' + o)) {
            $('#award-0' + o).show();
...
function stopLottery(cur_lottery, special) {
    ...
    var award_logs = _localhandle.local_handle.get('award_log');
    for (stop_index; stop_index < lengthed; stop_index++) {
        ...
        if (special && specialed == cur_lottery && queryParams.isCode == 1 && (award_logs['award06'] == 1 || award_logs['award06'] == 5 || award_logs['award02'] == 1)) {
    ...
    var local_award = _localhandle.local_handle.get('award_' + award);
    var award_tmp = null;
    if (local_award) {
        ...
        _localhandle.local_handle.set("award_" + award, JSON.stringify(award_datas));
    } else {
        var award_datas = [];
        award_tmp = {
            'nameen': lottery_name_en,
    ...
    _localhandle.local_handle.set("award_history", award);

    _localhandle.local_handle.delete(lottery_datas, lottery_name_en);

    award_log['award0' + award] -= 1;
    _localhandle.local_handle.set('award_log', JSON.stringify(award_log));
...
function awarded() {
    var select_award = _localhandle.local_handle.get('select_award');
    if (select_award) {
    ...
    $('.award').click(function () {
        ...
        _localhandle.local_handle.set('select_award', $(this).data('award'));
...
function music() {
    var music_local = _localhandle.local_handle.get('music') == '' ? '1' : _localhandle.local_handle.get('music');
    var music_config = {
        ...
        play: function play() {
            ...
            _localhandle.local_handle.set('music', 1);
            this.music_bool = true;
        },
        pause: function pause() {
            this.music.pause();
            $('#music-control').removeClass('animated infinite bounce');
            _localhandle.local_handle.set('music', 0);
...
function clearList() {
    $('#clear-control').click(function () {
        ...
        if (sure) {
            _localhandle.local_handle.clear();
            window.location.reload();
        }
    });
}
...
function showAward() {
    var award_history = _localhandle.local_handle.get('award_history');
    if (award_history == 6) {
        $('#award-06').show();
        $('#award-123').hide();
    }
...
function showmindan() {
    if (_localhandle.local_handle.get("mingdan_toggle") == 1) {
    ...
    if (_localhandle.local_handle.get("liwu_toggle") == 1) {
        $('#liwu-con').slideDown();
        $('#liwu').hide();
    } else {
        $('#liwu-con').hide();
    ...
    $('#mingdan').click(function () {
        ...
        _localhandle.local_handle.set("mingdan_toggle", 1);
    });
    $('#mingdan-title').click(function () {
        $('#mingdan-con').slideUp(1000);
        $('#mingdan').show();
        _localhandle.local_handle.set("mingdan_toggle", 0);
    });
    $('#liwu').click(function () {
        $(this).fadeOut();
        $('#liwu-con').slideDown(1000);
        _localhandle.local_handle.set("liwu_toggle", 1);
    });
    $('#liwu-title').click(function () {
        $('#liwu-con').slideUp(1000);
        $('#liwu').show();
        _localhandle.local_handle.set("liwu_toggle", 0);
    });
}
...
var lottery_initial_datas = [{
    ...
    "nameen": "avatar2",
    "namezh": "符江川",
    "wish": "“京鹏展翅，一飞冲天”， 祝大家在新年身体健康，阖家辛福。公司经过一年的艰苦奋斗" + "预计2018年一定会结出胜利的果实, 公司全体伙伴也必将共同成长，走向成功。"
}, {
    "nameen": "avatar3",
    "namezh": "赵永刚",
...
exports.lottery_initial_datas = lottery_initial_datas;
exports.award_config = award_config;
...
exports.local_handle = local_handle;
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<li class=\"clearfix win-li\">\n    <div class=\"f-l avatar\">\n        <img width=\"34\" src=\"./img/avatars/"
    + alias4(((helper = (helper = helpers.nameen || (depth0 != null ? depth0.nameen : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"nameen","hash":{},"data":data}) : helper)))
    + ".jpg\"/>\n    </div>\n    <div class=\"f-l name\">"
    + alias4(((helper = (helper = helpers.namezh || (depth0 != null ? depth0.namezh : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"namezh","hash":{},"data":data}) : helper)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.lotteryList : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <div class=\"clearfix lottery-list\" data-id=\"\" data-special=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.isSpecial : stack1), depth0))
    + "\" data-namezh=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.namezh : stack1), depth0))
    + "\" data-nameen=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.nameen : stack1), depth0))
    + "\">\n      <div class=\"f-l turqoise lottery-avatar\">\n          <img src=\"./img/avatars/"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.nameen : stack1), depth0))
    + ".jpg\" alt=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.namezh : stack1), depth0))
    + "\">\n      </div>\n      <div class=\"f-l lottery-content\">\n          <em class=\"beauty border-01\"></em>\n          <em class=\"beauty border-02\"></em>\n          <em class=\"beauty border-03\"></em>\n          <em class=\"beauty border-04\"></em>\n          <div class=\"border bor-top\"></div>\n          <div class=\"border bor-bottom\"></div>\n          <h3 class=\"content-title\"> <span class=\"lottery-name\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.namezh : stack1), depth0))
    + "</span> &nbsp;&nbsp;<span class=\"company\">[ 新鸥鹏 ]</span></h3>\n          <div class=\"content-detail\">\n              <b>新年愿景及祝福：</b>\n              <span>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.wish : stack1), depth0))
    + "</span>\n          </div>\n      </div>\n  </div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.lottery_datas : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
